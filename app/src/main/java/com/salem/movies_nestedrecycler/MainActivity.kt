...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myParentList = ArrayList<Parent>()
        ...
        myParentList.add(Parent("Oscar-Winning",oscarWiningList))
        myParentList.add(Parent("Favorite",favoriteList))
        myParentList.add(Parent("Action",actionList))
        myParentList.add(Parent("Horror",horrorList))
        myParentList.add(Parent("Comedy",comedyList))

        val myAdapter = ParentAdapter(this , myParentList)
        mainRec.layoutManager=LinearLayoutManager(this , LinearLayoutManager.VERTICAL  ,false)
        mainRec.adapter = myAdapter
